    ...
    <React.Fragment>
      ...
      >
        <div id="container" className=" px-6 sm:px-24 w-full h-full">
          <h1 className="text-white text-6xl Poppins">{Hero.heading}</h1>
            ...
            >
              <div id="container" className="px-6 sm:px-24 w-full h-full">
                <div className="grid grid-cols-1 sm:grid-cols-2 justify-between py-6 px-6 border-b-black">
                  <div className="">
                    <h3 className="text-3xl Poppins">{projectname}</h3>
                  ...
                  <div className="flex flex-col my-3 sm:my-0 sm:flex-row sm:justify-between">
                    ...
                    <Link
                      ...
                      target="_blank"
                      className={clsx(
                        "bg-black Poppins w-fit h-fit shrink-0  border-solid px-6 py-2 rounded-full border-2 duration-300 ",
                        index % 2 == 0
      ...
      >
        <div id="container" className=" px-6 sm:px-24 w-full h-full">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div>
              <h2 className="text-6xl text-white Poppins leading-none max-w-96">
                {CallToAction.title}
              </h2>
              <Link
                href="/"
                className="px-6 Poppins py-3 w-fit border-white border-2 text-xl hover:bg-white hover:text-black duration-300 text-white"
              >
                {CallToAction.label}
              </Link>
            </div>
