  ...
  return (
    ...
    >
      ...
      <div id="container" className=" px-6 sm:px-24 w-full h-full">
        <div className="text-white text-6xl Poppins">
          <h1>{Heading}</h1>
        </div>
        <div className="md:grid sm:grid-cols-2 xl:grid-cols-3 gap-3 grid grid-cols-1">
          {Content.map((element: ContentType, index: number) => {
            return (
              ...
              >
                <div>
                  <h2 className="text-xl Poppins font-bold leading-none">
                    {element.heading}
                  </h2>
                </div>
                ...
                <Link
                  ...
                  target="_blank"
                  className="text-white border-2 border-white py-3 Poppins  text-xl text-x text-center hover:bg-white hover:text-black duration-300"
                >
                  {CallToAction.title}
                </Link>
              </div>
