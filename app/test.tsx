          ...
          <div className="flex xl:flex-row xl:gap-64 flex-col h-full justify-center xl:items-center">
            <div className="flex flex-col h-full sm:justify-center xl:gap-12 xl:text-center">
              <p className="uppercase text-xl">
                FoxDesign Furniture for comfort living
              </p>
              <p>
      ...
      >
        <div id="container" className=" px-6 sm:px-24 w-full h-full">
          <div className="w-full h-fit">
            <h3 className="text-[100vh] leading-none Poppins tracking-tighter">
              FoxDesign
            </h3>
            <Image
      ...
      >
        <div id="container" className=" px-6 sm:px-24 w-full h-full">
          <div className="flex flex-col justify-center items-center">
            <h2 className="text-5xl Poppins">Our Expertise</h2>
          </div>
          <ul className="w-full h-full gap-6 flex flex-col sm:flex-row justify-between items-center">
            <li className=" w-full sm:w-1/2 flex justify-center relative items-center h-[330px] sm:h-full bg-black group duration-300 hover:border-4 hover:border-black hover:rounded-xl">
              <span className="text-2xl relative z-10 text-white Poppins group-hover:opacity-0 opacity-100 duration-300">
                Design Interior
              </span>
              <Image
...
//  };
{
  ...
  <div className="flex justify-between w-full items-center py-3 border-b-2 border-white">
    <Link href="/" className="Poppins text-white text-xl">
      FoxDesign
    </Link>
    ...
    <div>
      ...
      <button className="sm:block Poppins pt-1 hidden border-2 border-white rounded-full px-3 py-1 text-white hover:bg-white hover:text-black duration-300">
        Contact Us
      </button>
    </div>
  </div>
